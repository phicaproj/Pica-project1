      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl bg-[#111827] border border-white/5 p-6 flex flex-col items-center justify-center">
          <div className="relative mb-4">
            {uploading ? (
              ...
              <img
                ...
                className={`w-24 h-24 rounded-full object-cover ring-4 ring-[#0d1117] ${isEditing ? 'cursor-pointer hover:opacity-80 transition' : ''}`}
              />
            ) : (
              <div 
                onClick={triggerFileInput}
                className={`w-24 h-24 rounded-full bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center text-3xl font-bold text-white ring-4 ring-[#0d1117] ${isEditing ? 'cursor-pointer hover:opacity-80 transition' : ''}`}
              >
            ...
            {isEditing && (
              <button 
                onClick={triggerFileInput}
                className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-teal-500 hover:bg-teal-400 text-white flex items-center justify-center shadow-lg transition border-2 border-[#111827]"
              >
          ...
          {isEditing && (
            <button 
              onClick={triggerFileInput}
              className="w-full py-2.5 rounded-lg bg-white/5 border border-white/10 text-sm font-semibold text-white hover:bg-white/10 transition"
            >
              Replace Image
            </button>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm focus:outline-none focus:border-white/20 transition disabled:opacity-60 disabled:cursor-not-allowed"
              />
            </div>
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-2">
              ...
              <div className="relative">
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full px-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm focus:outline-none focus:border-white/20 transition pr-10 disabled:opacity-60 disabled:cursor-not-allowed"
                />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm focus:outline-none focus:border-white/20 transition pr-32 disabled:opacity-60 disabled:cursor-not-allowed"
              />
              {isVerified ? (
                ...
                <button 
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 inline-flex items-center gap-1.5 px-3 py-1 rounded text-[10px] font-bold uppercase bg-orange-500 hover:bg-orange-600 text-white transition"
                >
                  VERIFY EMAIL
                </button>
              )}
...
function BusinessInfoSettings({ initialUser, onUpdate }: { initialUser: any, onUpdate: () => void }) {
  ...
  const [location, setLocation] = useState(initialUser?.location || "Stockholm, Sweden");
  const [years, setYears] = useState(initialUser?.operatingYears || "12");
  ...
  useEffect(() => {
    if (initialUser) {
      ...
      setLocation(initialUser.location || "Stockholm, Sweden");
      setYears(initialUser.operatingYears || "12");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 rounded-xl bg-[#111827] border border-white/5 p-6 md:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm focus:outline-none focus:border-white/20 transition disabled:opacity-60"
              />
            </div>
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-2">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={!isEditing}
                  className="w-full px-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm appearance-none focus:outline-none focus:border-white/20 transition disabled:opacity-60"
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full pl-10 pr-4 py-3 rounded-lg bg-[#0d1117] border border-white/5 text-white text-sm focus:outline-none focus:border-white/20 transition disabled:opacity-60"
                />
              </div>
            </div>
            <div>
