    ...
    <div className={`antialiased min-h-screen transition-colors duration-300 pb-20 ${d ? "bg-[#0d1117] text-white" : "bg-white text-gray-900"}`}>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-8 mt-12 space-y-12">
        <div className={`p-6 rounded-2xl border ${d ? "bg-[#161b22] border-white/10" : "bg-gray-50 border-gray-200 shadow-sm"} text-sm leading-relaxed ${d ? "text-gray-300" : "text-gray-700"} space-y-4`}>
          <p>
            Welcome to <span className={`font-extrabold ${d ? "text-teal-400" : "text-teal-700"}`}>PICA™</span>, a proprietary software-as-a-service (SaaS) platform owned and operated by <span className={`font-extrabold ${d ? "text-teal-400" : "text-teal-700"}`}>Beauvision Associates Limited</span>. By registering, accessing, or using the PICA™ platform, you agree to be bound by these Terms of Service.
          </p>
        </div>
