...
const PERMISSIONS_LIST = [
  ...
  { key: 'consultations:read', label: 'View Consultation Bookings', description: 'Open the bookings inbox and client history.', icon: Inbox },
  { key: 'consultations:write', label: 'Manage Booking Schedules', description: 'Confirm, cancel, reschedule bookings and save notes.', icon: Inbox },
