...
export default function AdminLoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-[#0b0c10] overflow-hidden px-4">
      ...
      <div className="relative w-full max-w-md bg-[#161b22]/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl shadow-black/80">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <span className="text-white text-xs font-semibold tracking-[0.2em] uppercase text-blue-400">Secure Access</span>
          <h1 className="text-2xl font-bold text-white mt-1">PICA Admin Portal</h1>
        </div>
        ...
        {stage === "credentials" ? (
          <form onSubmit={handleCredentialsSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                disabled={isLoading}
                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-[#0d1117]/60 text-white placeholder-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition disabled:opacity-60"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={isLoading}
                  className="w-full px-4 py-3 rounded-xl border border-white/10 bg-[#0d1117]/60 text-white placeholder-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition pr-12 disabled:opacity-60"
                />
                <button
                  type="button"
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-6">
            <div className="text-center">
              ...
              <h2 className="text-sm font-semibold text-white">Enter Verification Code</h2>
            ...
            <div className="flex justify-center gap-2.5">
              {otp.map((digit, idx) => (
                <input
                  ...
                  className="w-11 h-13 text-center text-xl font-bold bg-[#0d1117]/80 text-white border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition disabled:opacity-50"
                />
              ))}
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full py-3 rounded-xl border border-white/10 hover:bg-white/5 text-gray-400 hover:text-white text-xs font-semibold tracking-wide transition"
              >
                Back to credentials
              </button>
            </div>
        ...
        <div className="mt-8 text-center border-t border-white/5 pt-6">
          <Link
            href="/"
            className="text-xs text-gray-500 hover:text-white transition uppercase tracking-wider font-semibold"
          >
            ← Back to main site
          </Link>
        </div>
