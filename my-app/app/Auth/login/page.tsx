...
// React responded to by tearing down and remounting the icon subtree on each
// keystroke. The visible result was a perceptible delay when toggling the
// password eye; this fixes it.
const EyeIcon = () => (
	<svg
	...
	return (
		<div className='min-h-screen w-full flex flex-col bg-[#0d1117]'>
			...
			<div className='flex-1 flex items-center justify-center px-4 py-10'>
                ...
                /Auth/login route can get back to the marketing pages without
							...
							<div>
								<div className='relative'>
									...
									<button
										...
										// No CSS transition here — the icon swap should feel
										// immediate. The hover color change is fine without it.
