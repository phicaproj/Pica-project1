...
const reportFilterParams = {
  ...
  dateFrom: z
    ...
    .openapi({
      ...
      example: '2026-01-01',
      description: 'Inclusive start date (YYYY-MM-DD), applied to session start date.',
    }),
  dateTo: z
    .string()
    .optional()
  ...
  country: z
    ...
    .openapi({
      ...
      description: 'Matched against the last comma-part of the session location.',
    }),
  state: z
    .string()
    .optional()
  ...
  status: z
    .enum(['IN_PROGRESS', 'COMPLETED', 'PAID', 'REPORT_GENERATED'])
    .optional()
  ...
  colorBand: z
    ...
    .optional()
    .openapi({
      param: { name: 'colorBand', in: 'query' },
      description: 'Overall result band of the session.',
    }),
  businessSize: z
    .enum(['SMALL', 'MEDIUM'])
    .optional()
  ...
  industry: z
    .string()
    .optional()
    .openapi({ param: { name: 'industry', in: 'query' } }),
};
