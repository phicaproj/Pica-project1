...
registry.registerPath({
	...
	description:
		'Public. Returns the created user. Email verification is a separate flow.',
	request: {
		body: {
			required: true,
...
registry.registerPath({
	...
	description:
		'Public. Requires the `passwordToken` obtained from /verify-reset-otp.',
	request: {
		body: {
			required: true,
