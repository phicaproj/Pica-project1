...
registry.registerPath({
  ...
  description: 'Authenticated. Returns the question set for a specific pillar in Phase 2B.',
  security: [{ bearerAuth: [] }],
  request: {
    query: z.object({
      pillarId: z
...
registry.registerPath({
  ...
  description: 'Authenticated. Returns metadata for all available pillars on the platform.',
  security: [{ bearerAuth: [] }],
  responses: {
    200: {
