...
const { PrismaClient } = client_2.default;
...
const PILLARS = [
    ...
    // ──────────────────────────────────────────────────────────
    {
        ...
        description: "Assesses the founder's time commitment, focus, and leadership capacity.",
        weight: 14.28,
        displayOrder: 1,
        questions: [
            {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        recommendation: "Re-evaluate if this is a business or a hobby before seeking funds.",
                    },
                ],
            },
            {
                ...
                options: [
                    {
                        ...
                        score: 10,
                        riskType: "NORMAL",
                        observation: "You operate at Commander level with a self-regulating leadership layer.",
                        recommendation: "Audit last 10 SMT decisions for alignment with strategy and identify one high-impact initiative to lead.",
                    },
                    {
                        label: "B",
                        ...
                        score: 7,
                        riskType: "RISK",
                        observation: "Managers execute but still depend on your approval for most decisions.",
                        recommendation: "Define approval thresholds and exit one operational unit for 2 weeks as an autonomy test.",
                    },
                    {
                        label: "C",
                        ...
                        score: 3,
                        riskType: "RISK",
                        observation: "You are the execution bottleneck; leadership layer is underdeveloped.",
                        recommendation: "Identify the top 5 decisions you still control daily and create a Standard of Excellence playbook.",
                    },
                    {
                        label: "D",
                        ...
                        score: 0,
                        riskType: "KNOCKOUT",
                        observation: "Structure mismatch; high burnout and collapse risk.",
                        recommendation: "Identify 2 internal leadership potentials and hire or appoint a GM/COO by Day 45.",
                    },
                ],
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────
    {
        ...
        description: "Evaluates the business's financial tracking, visibility, and discipline.",
        weight: 14.28,
        displayOrder: 2,
        questions: [
            {
                ...
                options: [
                    {
                        ...
                        recommendation: "Review last 3 months P&L, cash flow and expenses; set a weekly financial review meeting.",
                    },
                    {
                        label: "B",
                        ...
                        recommendation: "Introduce weekly cash flow tracking and build a simplified financial dashboard.",
                    },
                    {
                        label: "C",
                        ...
                        recommendation: "Set up bookkeeping software and reconstruct the last 3–6 months of financial data.",
                    },
                    {
                        label: "D",
                        ...
                        recommendation: "Hire an accountant/bookkeeper immediately and separate personal and business finances.",
                    },
                ],
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────
    {
        code: "BM",
        name: "Business Model",
        description: "Examines the clarity of the target customer, value proposition, and revenue logic.",
        weight: 14.28,
        displayOrder: 3,
        questions: [
            {
                ...
                options: [
                    {
                        ...
                        recommendation: "Identify top 2 revenue drivers by profitability and define one scaling lever.",
                    },
                    {
                        label: "B",
                        ...
                        recommendation: "Map all revenue streams and introduce one recurring revenue offer.",
                    },
                    {
                        label: "C",
                        ...
                        recommendation: "Build a subscription or retainer model and create a basic sales forecast.",
                    },
                    {
                        label: "D",
                        ...
                        recommendation: "Define your primary revenue source and validate willingness to pay through customer interviews.",
                    },
                ],
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────
    {
        code: "OP",
        name: "Operations",
        description: "Measures operational independence, systems strength, and founder dependency.",
        weight: 14.28,
        displayOrder: 4,
        questions: [
            {
                ...
                options: [
                    {
                        ...
                        recommendation: "Break down all cost categories and set a cost monitoring system.",
                    },
                    {
                        label: "B",
                        ...
                        recommendation: "Categorize all expenses and identify unnecessary costs.",
                    },
                    {
                        label: "C",
                        ...
                        recommendation: "Track all expenses for 30 days and build a cost structure framework.",
                    },
                    {
                        label: "D",
                        ...
                        recommendation: "Build a cost tracking system immediately and assign expense approval authority.",
                    },
                ],
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────
    {
        code: "MS",
        name: "Market & Sales",
        description: "Reviews customer acquisition channels, sales process effectiveness, and market positioning.",
        weight: 14.28,
        displayOrder: 5,
        questions: [
            {
                ...
                options: [
                    {
                        ...
                        recommendation: "Review conversion rates at each stage and document the full sales process.",
                    },
                    {
                        label: "B",
                        ...
                        recommendation: "Map your sales funnel stages and introduce a sales tracking system.",
                    },
                    {
                        label: "C",
                        ...
                        recommendation: "Define the sales process step-by-step and create a simple pitch structure.",
                    },
                    {
                        label: "D",
                        ...
                        recommendation: "Build a sales process from scratch and define all stages from lead to close.",
                    },
                ],
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────
    {
        ...
        description: "Assesses role clarity, documented policies, and organizational accountability.",
        weight: 14.28,
        displayOrder: 6,
        questions: [
            {
    ...
    // ──────────────────────────────────────────────────────────
    {
        ...
        description: "Determines whether the business can grow, replicate, and adapt without the founder.",
        weight: 14.28,
        displayOrder: 7,
        questions: [
            {
...
async function main() {
    ...
    console.log("\n🎉 Seed complete.");
    console.log(`   ${PILLARS.length} pillars | ${PILLARS.length * 2} questions | ${PILLARS.length * 2 * 4} options`);
}
main()
    .catch((e) => {
